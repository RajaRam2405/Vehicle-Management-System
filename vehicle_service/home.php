    ...
    <div class="container h-100 d-flex align-items-end justify-content-center w-100">
        <div class="text-center text-white w-100">
            ...
            <div class="col-auto mt-2">
                ...
                <a href="https://echallan.parivahan.gov.in/index/accused-challan#challan_list" target="_blank" class="btn btn-success btn-lg rounded-0 ms-2">Check Vehicle Challan</a>
            </div>
        </div>
    </div>
</header>
